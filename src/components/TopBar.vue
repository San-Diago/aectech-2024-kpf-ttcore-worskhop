    ...
    <div id="title-container">
      <div style="display: flex; align-items: center">
        ...
        <div id="navigation-tabs">
          ...
          <div :class="{ 'selected-tab': selectedExample === 3, 'navigation-tab': selectedExample !== 3 }" @click="toggleExample(3)">Andover Treeform</div>
          <div :class="{ 'selected-tab': selectedExample === 4, 'navigation-tab': selectedExample !== 4 }" @click="toggleExample(4)">100 HPD</div>
